...
output "public_subnet_ids" {value = values(aws_subnet.web_public_subnet)[*].id }
output "private_app_subnet_ids" {value = values(aws_subnet.private_app_subnet)[*].id }
output "private_data_subnet_ids" {value = values(aws_subnet.private_data_subnet)[*].id }
output "instance-sg" {value = aws_security_group.public_sg.id}
