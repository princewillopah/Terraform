output "vpc_id" {value = module.vpc-module.vpc_id}
output "public_subnet_ids" {value = module.vpc-module.public_subnet_ids}
output "private_app_subnet_ids" {value = module.vpc-module.private_app_subnet_ids}
output "private_data_subnet_ids" {value = module.vpc-module.private_data_subnet_ids}
