output "A_EC2_PUBLIC_SSH_Command" {
    value = "ssh -i ~/.ssh/id_rsa ubuntu@${aws_instance.a_public_ec2.public_ip}"
}
output "B_EC2_PUBLIC_SSH_Command" {
    value = "ssh -i ~/.ssh/id_rsa ubuntu@${aws_instance.b_public_ec2.public_ip}"
}
output "C_EC2_PUBLIC_SSH_Command" {
    value = "ssh -i ~/.ssh/id_rsa ubuntu@${aws_instance.c_public_ec2.public_ip}"
}


output "PUBLIC_EC2_A_SSH_Command_TO_PUBLIC_EC2_B" {
    value = "ssh -i /home/ubuntu/id_rsa ubuntu@${aws_instance.b_public_ec2.private_ip}"
}
output "PUBLIC_EC2_A_SSH_Command_TO_PRIVATE_EC2_B" {
    value = "ssh -i /home/ubuntu/id_rsa ubuntu@${aws_instance.b_private_ec2.private_ip}"
}

output "PUBLIC_EC2_A_SSH_Command_TO_PUBLIC_EC2_C" {
    value = "ssh -i /home/ubuntu/id_rsa ubuntu@${aws_instance.c_public_ec2.private_ip}"
}
output "PUBLIC_EC2_A_SSH_Command_TO_PRIVATE_EC2_C" {
    value = "ssh -i /home/ubuntu/id_rsa ubuntu@${aws_instance.c_private_ec2.private_ip}"
}
...
output "PUBLIC_EC2_C_SSH_Command_TO_PUBLIC_EC2_A" {
    value = "ssh -i /home/ubuntu/id_rsa ubuntu@${aws_instance.a_public_ec2.private_ip}"
}
...
output "ssh_key_to_ec2Apublic" {
    value = "scp -i ~/.ssh/id_rsa ~/.ssh/id_rsa ubuntu@${aws_instance.a_public_ec2.public_ip}:/home/ubuntu/"    
}
output "ssh_key_to_ec2Bpublic" {
    value = "scp -i ~/.ssh/id_rsa ~/.ssh/id_rsa ubuntu@${aws_instance.b_public_ec2.public_ip}:/home/ubuntu/"    
}

output "ssh_key_to_ec2Cpublic" {
    value = "scp -i ~/.ssh/id_rsa ~/.ssh/id_rsa ubuntu@${aws_instance.c_public_ec2.public_ip}:/home/ubuntu/"    
}



output "private_ip_for_publcic_ec2A" {
    value = "ping ${aws_instance.a_public_ec2.private_ip}"   
}
output "private_ip_for_private_ec2A" {
    value = "ping ${aws_instance.a_private_ec2.private_ip}"   
}
output "private_ip_for_publcic_ec2B" {
    value = "ping ${aws_instance.b_public_ec2.private_ip}"   
}
output "private_ip_for_private_ec2B" {
    value = "ping ${aws_instance.b_private_ec2.private_ip}"   
}
output "private_ip_for_publcic_ec2C" {
    value = "ping ${aws_instance.c_public_ec2.private_ip}"   
}
output "private_ip_for_private_ec2C" {
    value = "ping ${aws_instance.c_private_ec2.private_ip}"   
}
