...
Eventually your LuxeCart infra may become:
...
- Currently your NAT Gateway provides that.
- Without NAT:
   -  you'd need VPC endpoints.
...
| Internet OR VPC endpoints | reach AWS SSM service      |

Good news:

- Ubuntu AWS AMIs already include SSM agent usually
- your NAT Gateway already gives outbound internet
